...
Comment.create(content: "This is looking pretty cool so far", post_id: 1, user_id: 2)
Comment.create(content: "Thanks I'm trying hard!", post_id: 1, user_id: 1, parent_id: 1)
